...
all: grafana_hookshot.js grafana_hookshot.txt rageshake_sc_legacy_hookshot.js rageshake_sc_legacy_hookshot.txt rageshake_sc_next_hookshot.js rageshake_sc_next_hookshot.txt
